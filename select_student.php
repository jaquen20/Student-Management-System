    ...
    <!-- Header End -->
     ...
     if ($test==0) 
      ...
      else
      {
        ...
        <div class="container">
    <!-- <div class="col-xs-12"> -->
      <form method="POST" action="add_attendance_query.php">
     <br> <h2 align="center">Add Attendance</h2><br>
            ...
            if ($total==0) 
            {
              ...
              while ($row = mysqli_fetch_array($result))
             {
              ...
              <td>
                ...
                <input type="hidden" name="p_phone[]" value="<?= $row['p_contact'] ?>">
                ...
                <input type="radio" name="attendance[<?php echo $counter; ?>]" value="P" requierd>Present
                <input type="radio" name="attendance[<?php echo $counter; ?>]" value="A" requierd>Absent
              </td>
                 ...
                 <div class="button" ><button id="button" class="btn btn-primary" name="submit">Submit</button></div>
