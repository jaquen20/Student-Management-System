     ...
     if(isset($_POST['upd-btn']))
      { 
        ...
        if ($file_ext !="") 
        {
              ...
              $Update_query="UPDATE `student` SET `name`='$Name',`f_name`='$Fname',`gender`='$Gender',`dob`='$DOB',`branch`='$Branch',`contact`='$Contact',`p_contact`='$pcontact',`sem`='$sem',`email`='$Email',`address`='$Address',`image` ='".$file_ext."'
         WHERE `sno`='$id' ";
        ...
        {
          $Update_query="UPDATE `student` SET `name`='$Name',`f_name`='$Fname',`gender`='$Gender',`dob`='$DOB',`branch`='$Branch',`contact`='$Contact',`p_contact`='$pcontact',`sem`='$sem',`email`='$Email',`address`='$Address'
         WHERE `sno`='$id' ";
        }
        ...
        header('location:my_student_profile.php?status=success') ;
      }
