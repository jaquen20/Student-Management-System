...
<form action="forget_admin_query.php" method="post" autocomplete="off">
...
?>
      ...
      <div class="row rows">
        ...
        <div class="col-sm-5"><input type="text"  name="uname" class="box" minlength="4" maxlength="36" required></div>
      </div>
