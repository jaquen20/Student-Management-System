...
<style type="text/css">
    ...
    <div class="container" style="margin-top: 40px;">
      <h3 align="center">Select Branch and Semester for View Attendance</h3>
        <br>
        <form method="post" action="view_attendance_query.php">
          ...
          <div class="col-sm-3"></div>
           <div class="col-sm-8">
            <div class="row rows">
              ...
              <div class="col-sm-5">
                <select name="branch"  id="branch" class="sel" onchange="myfun(this.value)" required>
